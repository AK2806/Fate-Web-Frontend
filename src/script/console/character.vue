            ...
            <div class="breadcrumb-holder container-fluid">
                <div class="breadcrumb">
                    <div class="breadcrumb-item d-flex align-items-center">
                        <button v-if="selfId == userId" class="btn btn-primary" @click="openEditor()">创建角色卡</button>
                        <ul class="pagination px-3 m-0">
                            <li :class="{'page-item': true, 'disabled': characterPageIdx <= 0}">
                                <a class="page-link" href="javascript:void(0)" @click="characterPageIdx--">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </li>
                            <li v-for="i in characterPageCount" :key="'character-page-' + i"
                                :class="{'page-item': true, 'active': characterPageIdx + 1 == i}">
                                <a class="page-link" href="javascript:void(0)"
                                    @click="characterPageIdx = i - 1">{{ i }}</a>
                            </li>
                            <li :class="{'page-item': true, 'disabled': characterPageIdx >= characterPageCount - 1}">
                                <a class="page-link" href="javascript:void(0)" @click="characterPageIdx++">
